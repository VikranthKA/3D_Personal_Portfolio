...
const Logo = () => (
  <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" width="2000" height="1500" viewBox="0 0 2000 1500">
    <rect width="2000" height="1500" fill="#ffffff"></rect>
    <g transform="matrix(0.75,0,0,0.75,249.090909090909,278.98548387096776)">
            ...
            <g>
              <svg viewBox="0 0 395.52 247.2" height="247.2" width="395.52">
                <mask id="15bd62e5-3937-4a75-ae25-a8b85015c713">
                  ...
                  <g transform="matrix(1,0,0,1,128.5193152639087,37.08)">
                    <svg viewBox="0 0 138.4813694721826 173.04" height="173.04" width="138.4813694721826">
                      <g>
                        <svg viewBox="0 0 138.4813694721826 173.04" height="173.04" width="138.4813694721826">
                          <g>
                            <svg viewBox="0 0 138.4813694721826 173.04" height="173.04" width="138.4813694721826">
                              <g>
                                <svg viewBox="0 0 138.4813694721826 173.04" height="173.04" width="138.4813694721826">
                                  <g id="SvgjsG9146">
                                    <svg viewBox="0 0 138.4813694721826 173.04" height="173.04" width="138.4813694721826" id="SvgjsSvg9145">
                                      <g>
                                        <svg viewBox="0 0 138.4813694721826 173.04" height="173.04" width="138.4813694721826">
                                          <g transform="matrix(1,0,0,1,0,0)">
                                            <svg width="138.4813694721826" viewBox="-1.9 -33.55 29.049999999999997 36.05" height="173.04" data-palette-color="#ff9100">
                            ...
                            <g>
                              <svg viewBox="0 0 138.4813694721826 173.04" height="173.04" width="138.4813694721826">
                                <g id="textblocktransform">
                                  <svg viewBox="0 0 138.4813694721826 173.04" height="173.04" width="138.4813694721826" id="textblock">
                                    <g>
                                      <svg viewBox="0 0 138.4813694721826 173.04" height="173.04" width="138.4813694721826">
                                        <g transform="matrix(1,0,0,1,0,0)">
                                          <svg width="138.4813694721826" viewBox="-1.9 -33.55 29.049999999999997 36.05" height="173.04" data-palette-color="#ff9100">
                ...
                <g mask="url(#15bd62e5-3937-4a75-ae25-a8b85015c713)">
                  <g transform="matrix(2.7461802690412873, 0, 0, 2.7461802690412873, 75.16603184765192, 1)">
                    <svg version="1.1" x="0" y="0" viewBox="0.35833249999999595 0.3587183000000067 89.28326340000001 89.2876563" enableBackground="new 0 0 90 90" xmlSpace="preserve" height="89.2876563" width="89.28326340000001" className="icon-none" dataFillPaletteColor="accent" id="none">
                      ...
                      <rect x="67.864" y="35.981" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -9.3022 67.5465)" width="18.042" height="18.042" fill="#ffa414" dataFillPaletteColor="accent"></rect>
                      <rect x="35.979" y="4.094" transform="matrix(0.7071 -0.7071 0.7071 0.7071 3.9068 35.6621)" width="18.042" height="18.042" fill="#ffa414" dataFillPaletteColor="accent"></rect>
                      <rect x="4.095" y="35.98" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -27.9787 22.4536)" width="18.041" height="18.041" fill="#ffa414" dataFillPaletteColor="accent"></rect>
                      <rect x="35.98" y="67.865" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -41.1877 54.3437)" width="18.04" height="18.041" fill="#ffa414" dataFillPaletteColor="accent"></rect>
                    </svg>
                  </g>
                </g>
              </svg>
